...
* <https://github.com/agravgaard/pihole-kubernetes/tree/master/charts/pihole>
* <https://pi-hole.net/>
...
| doh.resources | object | `{}` | lines, adjust them as necessary. |
...
| Name | Email | Url |
| ---- | ------ | --- |
| agravgaard | andreasga22+pihole@gmail.com |  |
...
Feel free to contribute by making a [pull request](https://github.com/agravgaard/pihole-kubernetes/pull/new/master).
